...
void initializeVideoDepacketizer(int pktSize) {
    // PS3's hardware decoder (vdec) has variable decode latency and a small
    // internal queue.  A larger software queue absorbs transient stalls without
    // triggering the catastrophic overflow → IDR storm cycle.  120 frames
